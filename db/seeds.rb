...
permissionSet = Permission.create([{"name": "property"}, {"name": "user"}, {"name": "ship"}, {"name": "park"}, {"name": "ground"}, {"name": "corp"}, {"name": "sponsor"}, {"name": "tenant"}, {"name": "auth"}, {"name": "microsites"}]) 
